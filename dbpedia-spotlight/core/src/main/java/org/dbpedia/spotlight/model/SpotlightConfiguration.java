...
public class SpotlightConfiguration {
	...
	private static String dbpediaResource="http://dbpedia.org/resource/";

	private static String dbpediaOntology="http://dbpedia.org/ontology/";
	...
	public static String getDbpediaResource() {
		return dbpediaResource;
	}

	public static String getDbpediaOntology() {
	...
	public SpotlightConfiguration(String fileName) throws ConfigurationException {
		...
		//...
		System.out.println("Se ejecuta constructor de SpotlightConfiguration");
	}
